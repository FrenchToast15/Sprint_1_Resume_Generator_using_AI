...
user_describe_yourself = input(
    "Please insert a description of you and your skills: ")
print(user_describe_yourself)

# Set up messages for Ollama
messages = [
    {"role": "system",
     "content": "You are an AI that helps build a resume in markdown format by analyzing"
                "the user_describe_yourself and making it fit the user_job_desc_"},
...
response = ollama.chat(
    model="llama3.2",
    messages=messages)  # Ensure correct model name
