from database import create_database_rapid_results, insert_rapid_results_data_into_db, insert_rapid_jobs_2_data_into_db, create_database_rapid_jobs_2, create_database_rapid_jobs_2_providers
...
insert_rapid_results_data_into_db(parsed_data) # Inserts parsed data into database
